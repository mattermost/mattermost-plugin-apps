...
func TestUnmarshalCallRequest(t *testing.T) {
	...
	require.Equal(t, "b3snp6tk6pbh9fxjpbhqn5hzgh", data.GetValue(PropBotAccessToken, ""))
	require.Equal(t, "cywc3e8nebyujrpuip98t69a3h", data.GetValue(PropOAuth2ClientSecret, ""))
