...
func (a *AppServices) KVList(r *incoming.Request, appID apps.AppID, actingUserID, prefix string, processf func(key string) error) error {
	return a.store.AppKV.List(r, actingUserID, prefix, processf)
}
