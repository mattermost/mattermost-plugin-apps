...
func (s *Service) GetBotIDs(r *incoming.Request, w http.ResponseWriter, _ *http.Request) {
...
func (s *Service) GetOAuthAppIDs(r *incoming.Request, w http.ResponseWriter, _ *http.Request) {
	apps := s.Proxy.GetInstalledApps()
	ids := []string{}
	for _, app := range apps {
