...
func (m *MockService) UninstallApp(arg0 apps.AppID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UninstallApp", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// UninstallApp indicates an expected call of UninstallApp
func (mr *MockServiceMockRecorder) UninstallApp(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UninstallApp", reflect.TypeOf((*MockService)(nil).UninstallApp), arg0)
}
