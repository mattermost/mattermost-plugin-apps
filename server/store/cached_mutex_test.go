...
type CachedStoreTestType struct {
	ID   string
	Body string
}

func (t CachedStoreTestType) Clone() *CachedStoreTestType {
	return &t
}

func TestMutexCachedStore(t *testing.T) {
	...
	cluster := NewCachedStoreCluster(conf.API(), TestCachedStoreKind)

	s, err := makeMutexCachedStore[CachedStoreTestType]("test", cluster, conf.NewBaseLogger())
	require.NoError(t, err)

	r := incoming.NewRequest(conf, nil, "test", "reqid")
	put := func(id string, data CachedStoreTestType, indexBefore, indexAfter string) {
		...
		api.On(
			...
			Run(
				func(args mock.Arguments) {
					...
					require.True(t, ok)
					require.Equal(t, "cached_store_data/test", e.Id)
					...
					require.Equal(t, data, *event.Value)
	...
	t.Run("happy put and delete", func(t *testing.T) {
		...
		put("3",
			CachedStoreTestType{ID: "3", Body: "test3"},
			`{"Data":[{"k":"1","h":"a74d512a5bc25ef815367c51c2bfa7535d1d73079fd9909f4a7d2ef4d256ff22"},{"k":"2","h":"76e8644d57eabcb1b39ae54908855de7bb6b53426f1519d88e772e16a18112ce"}]}`,
		...
		put("2",
			CachedStoreTestType{ID: "2", Body: "test2-updated"},
			`{"Data":[{"k":"1","h":"a74d512a5bc25ef815367c51c2bfa7535d1d73079fd9909f4a7d2ef4d256ff22"},{"k":"2","h":"76e8644d57eabcb1b39ae54908855de7bb6b53426f1519d88e772e16a18112ce"},{"k":"3","h":"d0b3bd259bb16568511cc24e41411895c16a58a579f00d9c8638b724c39824d0"}]}`,
