...
func (p *Proxy) UninstallApp(r *incoming.Request, cc apps.Context, appID apps.AppID, force bool) (_ string, err error) {
	...
	u := uninstaller{
		deleteApp:                 func() error { return p.store.App.Delete(r, appID) },
		deleteAppData:             func() error { return p.appservices.DeleteAppData(r, appID, force) },
		deleteMattermostOAuth2App: func() error { return r.API.Mattermost.OAuth.Delete(app.MattermostOAuth2.Id) },
		disableApp:                func() error { _, e := p.DisableApp(r, cc, appID); return e },
		disableBotAccount:         func() error { _, e := r.API.Mattermost.Bot.UpdateActive(app.BotUserID, false); return e },
		revokeSessionsForApp:      func() error { return p.store.Session.DeleteAllForApp(r, app.AppID) },
