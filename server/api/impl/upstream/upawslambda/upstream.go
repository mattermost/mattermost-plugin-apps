...
func (u *Upstream) OneWay(call *apps.Call) error {
	_, err := u.aws.InvokeLambda(u.app.Manifest.AppID, u.app.Manifest.Version, call.Path, lambda.InvocationTypeEvent, call)
	return err
}

func (u *Upstream) Roundtrip(call *apps.Call) (io.ReadCloser, error) {
	bb, err := u.aws.InvokeLambda(u.app.Manifest.AppID, u.app.Manifest.Version, call.Path, lambda.InvocationTypeRequestResponse, call)
	if err != nil {
		return nil, err
	}
