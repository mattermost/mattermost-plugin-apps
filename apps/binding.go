...
type Binding struct {
	...
	// Used for specifying a UI element in a view
	Type BindingType `json:"type,omitempty"`

	// Used for specifying a variant of a given UI element in a view
	Subtype BindingSubtype `json:"subtype,omitempty"`
	...
	// Source is used to dynamically load UI elements, such as App Bar RHS views.
