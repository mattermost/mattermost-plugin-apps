...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination server/mocks/mock_store/mock_app.go github.com/mattermost/mattermost-plugin-apps/server/store App
	mockgen -destination server/mocks/mock_store/mock_mannifest.go github.com/mattermost/mattermost-plugin-apps/server/store Manifest
	mockgen -destination server/mocks/mock_store/mock_subscription.go github.com/mattermost/mattermost-plugin-apps/server/store Subsctiption
endif
